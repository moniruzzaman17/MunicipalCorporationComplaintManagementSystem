...
<!--Refresh Button Clicking Event.. for which all post will be shown-->
				...
				/*  SELECT * FROM complaint WHERE upazila_code='$upa_code' ORDER BY post_id DESC */
					$post_type_c="Crime";
					$sql_post_view = mysqli_query($conn, "SELECT * FROM complaint, user_info WHERE  complaint.post_type='$post_type_c' AND complaint.district_code='$district_code' AND user_info.full_name=complaint.user_fullname ORDER BY post_id DESC");
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form action="rating_sql.php" method="POST">
									<input type="hidden" name="page_location" value="home_for_district_crime">
				...
				<div class="post_body_right">
					<div class="post_body_right_container">
						...
						<p style="text-align: center; font-size: 18px;">by</p>
						<a style="background-color: #e44d3a; color: white; padding-left: 16%; padding-right: 16.8%;" href="home_for_district_crime.php">Your District</a> <br><br>
