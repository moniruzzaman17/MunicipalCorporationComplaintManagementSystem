			...
			<div class="post_body_left">
				<div class="post_body_left_container">
					...
					<p style="text-align: center; font-size: 18px;">by</p>
						<a style="background-color: #e44d3a; color: white; padding-left: 16%; padding-right: 16.8%;" href="home_for_district.php">Your District</a> <br><br>
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form action="rating_sql.php" method="POST">
									<input type="hidden" name="page_location" value="home_for_district">
