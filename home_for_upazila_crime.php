...
<!--Refresh Button Clicking Event.. for which all post will be shown-->
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form action="rating_sql.php" method="POST">
									<input type="hidden" name="page_location" value="home_for_upazila_crime">
				...
				<div class="post_body_right">
					<div class="post_body_right_container">
						...
						<a style="background-color: #e44d3a; color: white; padding-left: 15.5%; padding-right: 16.9%;" href="home_for_upazila_crime.php">Your Upazila</a> <br><br>
