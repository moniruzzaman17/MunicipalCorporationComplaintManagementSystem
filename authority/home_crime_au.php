	...
	<div class="container">
		<div class="post_body">
			...
			<div class="post_body_middle">
				...
				$post_type_c="Crime";
				$sql_post_view = mysqli_query($conn, "SELECT * FROM complaint, user_info WHERE  complaint.post_type='$post_type_c' AND user_info.full_name=complaint.user_fullname ORDER BY post_id DESC");
				while ($row_post = mysqli_fetch_array($sql_post_view)) 
				{
					$post_user_name=$row_post['user_fullname'];
					$user_id=$row_post['user_name'];
						...
						<div class="post-show-inner">
							<div class="post-header">
								<div class="post-left-box">
									...
									<div class="id-name">
										<ul>
											<li><a href="#" style="cursor: pointer;" onclick="MyWindow=window.open('send_message.php?user_id=<?php echo $user_id; ?>&post_id=<?php echo $post_id; ?>&sender_id=<?php echo $current_user_id; ?>', 'MyWindow', 'width=400, height=100'); return false;">Anonymous</a></li>
								...
								<div class="post-img">
									<center>
										...
										if (isset($row_post['attatchment']) || !empty($row_post['attatchment'])) { ?>
											<img align="center" src="../post_image/<?php echo $row_post['attatchment']; ?>" style="color: gray;"></img>
				       ...
				       #sql for mores important Count
								...
								<div class="post-footer">
									<div class="post_footer_inner">
										<form>
											<input type="hidden" name="page_location" value="home_crime_au">
									      ...
									      //Condition for color effect of more important button
											...
											<div class="comment_div">
												<form>
													...
													<input type="hidden" name="post_type" value="Crime">
...
<div class="post_body_right">
	<div class="post_body_right_container">
		...
		<a style="background-color: #e44d3a; color: white; padding-left: 11%; padding-right: 10.5%; margin-left: 13%;" href="home_crime_au.php">View All General Complaint</a>
	</div>
</div>
</div> <!--END of Post BOdy-->
