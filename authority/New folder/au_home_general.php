			...
			<div class="post_body_left">
				<div class="post_body_left_container">
					...
					<p style="text-align: center; font-size: 18px;">by</p>
						...
						<a style="background-color: #e44d3a; color: white; padding-left: 11%; padding-right: 10.5%; margin-left: 13%;" href="au_home_general.php">View All General Complaint</a>
				</div>
			</div>
			...
			<div class="post-show" id="<?php echo $row_post['post_id']; ?>">
				<div class="post-show-inner">
					...
					<div class="post-body">
						...
						<!--PHP CODE-->
						<?php
						$u_name=$_SESSION['au_fullname'];
							//CODE for getting Profile Image location from database
						$sql = mysqli_query($conn, "SELECT au_user_id FROM authority_info WHERE au_name='$u_name'");
								while ($row = mysqli_fetch_array($sql)) 
							       {
							       	$user_name= $row['au_user_id'];
							       }	
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form action="rating_sql.php" method="POST">
									<input type="hidden" name="page_location" value="authority/home_general">
								...
								<div class="authority_review" >
									...
									<div class="authority_review_container">
										<div class="review_content" >
												...
												<hr>
										<?php 
											$sql_review=mysqli_query($conn, "SELECT * FROM authority_review, authority_info WHERE authority_info.au_user_id=authority_review.authority_user_id ORDER BY review_id DESC");
