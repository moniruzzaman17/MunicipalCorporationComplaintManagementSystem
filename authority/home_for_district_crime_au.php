								...
								<div class="post-show-inner">
									<div class="post-header">
										<div class="post-left-box">
											...
											<div class="id-name">
												<ul>
													<li><a style="cursor: pointer;" onclick="MyWindow=window.open('send_message.php?user_id=<?php echo $user_id; ?>&post_id=<?php echo $post_id; ?>', 'MyWindow', 'width=600, height=200'); return false;">Anonymous</a></li>
					...
					while ($row3 = mysqli_fetch_array($sql_most_important_count)) 
				       {
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form>
									<input type="hidden" name="page_location" value="home_for_district_crime_au">
