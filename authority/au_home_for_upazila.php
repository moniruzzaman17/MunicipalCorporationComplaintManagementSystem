			...
			<div class="post_body_left">
				<div class="post_body_left_container">
					...
					<p style="text-align: center; font-size: 18px;">by</p>
						<a style="background-color: #e44d3a; color: white; padding-left: 16%; padding-right: 17%; margin-left: 13%;" href="au_home_for_upazila.php">Your Working Upazila</a> <br><br>
					...
					while ($row3 = mysqli_fetch_array($sql_most_important_count)) 
				       {
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form>
									<input type="hidden" name="page_location" value="au_home_for_upazila">
