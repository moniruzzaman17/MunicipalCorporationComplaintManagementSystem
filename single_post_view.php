...
<!--Refresh Button Clicking Event.. for which all post will be shown-->
			...
			<div style="width: 93%; margin-left: 8%;" class="post-show" id="<?php echo $row_post['post_id']; ?>">
					...
					while ($row3 = mysqli_fetch_array($sql_most_important_count)) 
				       {
						...
						<div class="post-footer">
							<div class="post_footer_inner">
								<form>
									<input type="hidden" name="page_location" value="single_post_view">
									...
									if($fetch==false)
									{ ?>
									    <button class="review_btn" name="less_im_btn" disabled>Less Important</button><?php echo $less_count; ?>
										<button class="review_btn" name="im_btn" disabled>Important</button><?php echo $im_count; ?>
										<button class="review_btn" name="more_i_btn" disabled>Most Important</button><?php echo $most_count; ?>
									<?php }
						...
						<hr style="margin-top: 2%; margin-bottom: 3%; border:0.5px solid gray;">
							...
							<div class="comment_div">
								<form>
									...
									<button class="post_comment_button" name="p_c_btn" disabled>Post</button>
								</form>
								<hr style="margin-top: 2%; margin-bottom: 3%; border:0.5px solid gray;">
											...
											-->
												...
												<small style="margin: 0% 2%;">
													...
													<input type="hidden" name="comment_id" value="<?php echo $comment_id; ?>">
														<input class="comment_delete_btn" type="submit" name="submit" value="Delete" disabled>
														<?php } ?>
												</small>
											</p>
										</div>
								...
								<?php } ?>
										...
										<div>
												<form style="margin-left: 22%; margin-top: 5%;">
													...
													<input type="hidden" name="user_name" value="<?php echo $user_id; ?>">
													<input type="text" class="comment_reply_box" name="reply_text" placeholder="Reply here">
													<button class="comment_reply_button" name="p_c_btn" disabled>Reply</button>
												</form>
										</div>
